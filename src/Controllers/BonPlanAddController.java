 ...
 * @author Radhi
 */
public class BonPlanAddController implements Initializable {

    @FXML
    private JFXTextField nomBP;
    @FXML
    private JFXTextField typeBP;
    @FXML
    private JFXTextArea descBP;
    @FXML
    private JFXTextField imgBP;
    @FXML
    ...
    @FXML
    private void makeAddPlan(ActionEvent event) {
    }
    ...
    @FXML
    private void makeAjouterBP(ActionEvent event) {
